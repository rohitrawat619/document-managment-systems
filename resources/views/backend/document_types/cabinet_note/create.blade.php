                    ...
                    <div class="card-body p-4">
                        ...
                        <meta name="csrf-token" content="{{ csrf_token() }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="cabinet" name="cabinet" placeholder="">
...
<script type="text/javascript">
	$(document).ready(function () {
        $('#sub').click(function(e){
                ...
                if($('#cabinet').val()=="")
				{
                    $('#cabinet_error').text("Please Enter cabinet Name").show();
					$('#cabinet').focus();
					return false;
				}
...
$(document).ready(function() {
    ...
    var cabinet_noteStoreUrl = "{{ url('admin/document/cabinet_note/create') }}";
    ...
    $(document).ready(function() {
        ...
        $('select[name="user"]').on('change', function() {
            ...
            if(userId) {
                ...
                $.ajax({
                    url: "{{ route('admin.document.cabinet_note.get-divisions-by-user') }}",
                    type: 'GET',
                    data: { user_id: userId },
