    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                ...
                @endphp
                <a href="{{ in_array(42, $userPermissions) ? route('admin.document.guideline.create') : 'javascript:void(0);' }}" 
                        ...
                        <table class="table mb-0 table-hover table-bordered userTable">
                            ...
                            <tr>
                                ...
                                @if(in_array(42, $userPermissions))
                                        <a href="{{ route('admin.document.guideline.edit', ['id' => base64_encode($r->id)]) }}" title="Edit">
