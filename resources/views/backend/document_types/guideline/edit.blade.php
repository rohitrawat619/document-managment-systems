            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('admin.document.guideline.index')}}">Guidelines</a>
                        </li>
                    ...
                    <div class="card-body p-4">
                        <form id="guidelineForm" action="{{ route('admin.document.guideline.edit', $guideline->id) }}" method="post" class="row g-3" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="computer_no" name="computer_no" value="{{ $guideline->computer_no }}" placeholder="computer no">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="file_no" name="file_no" value="{{ $guideline->file_no }}" placeholder="L-1222/1/2024-IA-I-(R)">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" id="date_of_issue" name="date_of_issue" value="{{ $guideline->date_of_issue }}" placeholder="date of issue">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="subject" name="subject" value="{{ $guideline->subject }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="issuer_name" name="issuer_name" value="{{ $guideline->issuer_name }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="issuer_designation" name="issuer_designation" value="{{ $guideline->issuer_designation }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" name="file_type">
                                    <option value="0" @if($guideline->file_type == 0) selected @endif>Confidential</option>
                                    <option value="1" @if($guideline->file_type == 1) selected @endif>Non-Confidential</option>
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="field_wrapper">
                                    ...
                                    @else
                                        @foreach($guideline_upload as $key => $omu)
...
$(document).ready(function() {
    ...
    if (filePath) {
        if (confirm('Are you sure you want to delete this file?')) {
            ...
            $.ajax({
                url: "{{ route('admin.document.guideline.delete_file') }}", 
                type: 'DELETE',
                data: {
                    _token: "{{ csrf_token() }}",
                    file_path: filePath,
