            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('admin.document.letter.index')}}">Letter</a>
                        </li>
            ...
            <div class="col-xl-12 mx-auto">
                <div class="card">
                    <div class="card-body p-4">
                        <form action="{{ route('admin.document.letter.edit', $letter->id) }}" method="post" class="row g-3" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="file_no" name="file_no" value="{{ $letter->file_no }}" placeholder="L-1222/1/2024-IA-I-(R)">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" id="date_of_issue" name="date_of_issue" value="{{ $letter->date_of_issue }}" placeholder="date of issue">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="subject" name="subject" value="{{ $letter->subject }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="issuer_name" name="issuer_name" value="{{ $letter->issuer_name }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="issuer_designation" name="issuer_designation" value="{{ $letter->issuer_designation }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" name="file_type">
                                    <option value="0" @if($letter->file_type == 0) selected @endif>Confidential</option>
                                    <option value="1" @if($letter->file_type == 1) selected @endif>Non-Confidential</option>
                                </select>
...
$(document).ready(function() {
    ...
    if (filePath) {
        if (confirm('Are you sure you want to delete this file?')) {
            ...
            $.ajax({
                url: "{{ route('admin.document.letter.delete_file') }}", 
                type: 'DELETE',
                data: {
                    _token: "{{ csrf_token() }}",
                    file_path: filePath,
