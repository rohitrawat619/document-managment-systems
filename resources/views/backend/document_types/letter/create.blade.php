            ...
            <div class="col-xl-12 mx-auto">
                <div class="card">
                    <div class="card-body p-4">
                        <form action="{{route('admin.document.letter.create')}}" method="post" class="row g-3" enctype="multipart/form-data">
                            @csrf
                                <div class="col-md-6">
    ...
    $(document).ready(function() {
        ...
        $('select[name="user"]').on('change', function() {
            ...
            if(userId) {
                ...
                $.ajax({
                    url: "{{ route('admin.document.letter.get-divisions-by-user') }}",
                    type: 'GET',
                    data: { user_id: userId },
