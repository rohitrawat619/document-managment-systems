            ...
            <div class="col-xl-12 mx-auto">
                <div class="card">
                    <div class="card-body p-4">
                        <form action="" id ="vip_referenceForm" method="post" class="row g-3" enctype="multipart/form-data">
                        <meta name="csrf-token" content="{{ csrf_token() }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="vip" name="vip" placeholder="">
                            ...
                            <div class="col-md-6">
                                <label for="date_of_sent" class="form-label">Date of Reply Sent <span class="text-danger">*</span></label>
                                <input type="date" class="form-control" id="date_of_sent" name="date_of_sent" placeholder="date of Publication">
                                <div id="date_of_sent_error" style="color: red; display: none;"></div>
                            </div>
...
<script type="text/javascript">
	$(document).ready(function () {
        $('#sub').click(function(e){
                ...
                if($('#date_of_receipt').val()=="")
				{
                    $('#date_of_receipt_error').text("Please Enter Date of Receipt").show();
                ...
                if($('#vip').val()=="")
				{
                    $('#vip_error').text("Please Enter VIP Name").show();
					$('#vip').focus();
					return false;
				}
                ...
                if($('#date_of_sent').val()=="")
				{
                    $('#date_of_sent_error').text("Please Enter Date of Sent").show();
					$('#date_of_sent').focus();
					return false;
				}
...
$(document).ready(function() {
    ...
    var vip_referenceStoreUrl = "{{ url('admin/document/vip_reference/create') }}";
    ...
    $(document).ready(function() {
        ...
        $('select[name="user"]').on('change', function() {
            ...
            if(userId) {
                ...
                $.ajax({
                    url: "{{ route('admin.document.vip_reference.get-divisions-by-user') }}",
                    type: 'GET',
                    data: { user_id: userId },
