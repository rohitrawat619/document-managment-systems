            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('admin.document.vip_reference.index')}}">VIP Reference</a>
                        </li>
            ...
            <div class="col-xl-12 mx-auto">
                <div class="card">
                    <div class="card-body p-4">
                        <form id="vip_referenceForm" action="{{ route('admin.document.vip_reference.edit', $vip_reference->id) }}" method="post" class="row g-3" enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-6">
                                <label for="computer_no" class="form-label">Computer No.(E/P) <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="computer_no" name="computer_no" value="{{ $vip_reference->computer_no }}" placeholder="computer no">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="file_no" name="file_no" value="{{ $vip_reference->file_no }}" placeholder="L-1222/1/2024-IA-I-(R)">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" id="date_of_receipt" name="date_of_receipt" value="{{ $vip_reference->date_of_receipt }}" placeholder="date of issue">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="subject" name="subject" value="{{ $vip_reference->subject }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                <label for="vip" class="form-label">Name of VIP <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="vip" name="vip" value="{{ $vip_reference->vip }}" >
                                <div id="vip_error" style="color: red; display: none;"></div>
                            </div>

                            <div class="col-md-6">
                                <label for="action" class="form-label">Action Taken <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="action" name="action" value="{{ $vip_reference->action }}" >
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="issuer_name" name="issuer_name" value="{{ $vip_reference->issuer_name }}" readonly>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="issuer_designation" name="issuer_designation" value="{{ $vip_reference->issuer_designation }}" readonly>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="key" name="key" value="{{ str_replace(',', ' ', $vip_reference->keyword) }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="field_wrapper">
                                    @if(count($vip_reference_upload) == 0)
                                    ...
                                    @else
                                        @foreach($vip_reference_upload as $key => $omu)
...
$(document).ready(function() { 
    $('#vip_referenceForm').on('submit', function(e) {
        e.preventDefault();  
        ...
        $.ajax({
            ...
            success: function(response) { 
                    // alert(response);
                    // window.location.href = "{{ route('admin.document.vip_reference.index') }}";
                    Swal.fire({
                    title: "Success!",
...
$(document).ready(function() {
    ...
    if (filePath) {
        if (confirm('Are you sure you want to delete this file?')) {
            ...
            $.ajax({
                url: "{{ route('admin.document.vip_reference.delete_file') }}", 
                type: 'DELETE',
                data: {
                    _token: "{{ csrf_token() }}",
                    file_path: filePath,
