            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('admin.document.pragati.index')}}">Pragati</a>
                        </li>
            ...
            <div class="col-xl-12 mx-auto">
                <div class="card">
                    <div class="card-body p-4">
                        <form id="cabinet_noteForm" action="{{ route('admin.document.pragati.edit', $cabinet_note->id) }}" method="post" class="row g-3" enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="agenda" name="agenda" value="{{ $cabinet_note->agenda }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="action" name="action" value="{{ $cabinet_note->action_taken }}" >
                                <div id="action_error" style="color: red; display: none;"></div>
                            </div>

                            <div class="col-md-6">
                                <label for="date_of_upload" class="form-label">Date of Reply <span class="text-danger">*</span></label>
                                <input type="date" class="form-control" id="date_of_reply" name="date_of_reply" value="{{date('Y-m-d')}}" placeholder="date of reply" readonly>
                                @if ($errors->has('date_of_reply'))
                                    <span class="invalid-feedback">
                                        <strong>{{ $errors->first('date_of_reply') }}</strong>
                                    </span>
                                @endif
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="key" name="key" value="{{ str_replace(',', ' ', $cabinet_note->keywords) }}" placeholder="">
...
$(document).ready(function() {
    ...
    if (filePath) {
        if (confirm('Are you sure you want to delete this file?')) {
            ...
            $.ajax({
                url: "{{ route('admin.document.pragati.delete_file') }}", 
                type: 'DELETE',
                data: {
                    _token: "{{ csrf_token() }}",
                    file_path: filePath,
