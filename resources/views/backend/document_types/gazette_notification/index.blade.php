    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                ...
                @endphp
                <a href="{{ in_array(42, $userPermissions) ? route('admin.document.gazette_notification.create') : 'javascript:void(0);' }}" 
                            ...
                            @forelse ($gazette_notification as $k => $r)
                                <tr>
                                    ...
                                    @if(in_array(42, $userPermissions))
                                        <a href="{{ route('admin.document.gazette_notification.edit', ['id' => base64_encode($r->id)]) }}" title="Edit">
