                    ...
                    <div class="card-body p-4">
                        <form id ="memorandumForm" action="{{ route('admin.document.gazette_notification.edit', $gazette_notification->id) }}" method="post" class="row g-3" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="title" name="title" value="{{ $gazette_notification->title }}" placeholder="L-1222/1/2024-IA-I-(R)">
                                @if ($errors->has('title'))
                                    <span class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" id="date_of_notification" name="date_of_notification" value="{{ $gazette_notification->date_of_notification }}" placeholder="date of issue">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="issuer_name" name="issuer_name" value="{{ $gazette_notification->issuer_name }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="issuer_designation" name="issuer_designation" value="{{ $gazette_notification->issuer_designation }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="key" name="key" value="{{ str_replace(',', ' ',$gazette_notification->keyword) }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="field_wrapper">
                                    @if(count($gazette_notification_upload) == 0)
                                    ...
                                    @else
                                        @foreach($gazette_notification_upload as $key => $omu)
...
<script type="text/javascript">
	$(document).ready(function () {
        $('#sub').click(function(e){
            if($('#title').val()=="")
				{
                    $('#title1').text("Please Enter File No").show();
					$('#title').focus();
					return false;
				}
...
$(document).ready(function() {
    ...
    if (filePath) {
        if (confirm('Are you sure you want to delete this file?')) {
            ...
            $.ajax({
                url: "{{ route('admin.document.gazette_notification.delete_file') }}", 
                type: 'DELETE',
                data: {
                    _token: "{{ csrf_token() }}",
                    file_path: filePath,
