                    ...
                    <div class="card-body p-4">
                        <form id="notificationForm" action="{{ route('admin.document.notification.edit', $notification->id) }}" method="post" class="row g-3" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="file_no" name="file_no" value="{{ $notification->file_no }}" placeholder="L-1222/1/2024-IA-I-(R)">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" id="date_of_issue" name="date_of_issue" value="{{ $notification->date_of_issue }}" placeholder="date of issue">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="subject" name="subject" value="{{ $notification->subject }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="issuer_name" name="issuer_name" value="{{ $notification->issuer_name }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="issuer_designation" name="issuer_designation" value="{{ $notification->issuer_designation }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" name="file_type">
                                    <option value="0" @if($notification->file_type == 0) selected @endif>Confidential</option>
                                    <option value="1" @if($notification->file_type == 1) selected @endif>Non-Confidential</option>
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="key" name="key" value="{{ str_replace(',', ' ',$notification->keyword) }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="field_wrapper">
                                    @if(count($notification_upload) == 0)
                                    ...
                                    @else
                                        @foreach($notification_upload as $key => $omu)
                            ...
                            <div class="col-md-12">
                                <div class="d-md-flex d-grid align-items-center gap-3">
                                    <button type="submit" id ="sub" class="btn btn-primary px-4" style="margin-bottom: 1%;margin-left: 1%;">Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
$(document).ready(function() {
    ...
    if (filePath) {
        if (confirm('Are you sure you want to delete this file?')) {
            ...
            $.ajax({
                url: "{{ route('admin.document.notification.delete_file') }}", 
                type: 'DELETE',
                data: {
                    _token: "{{ csrf_token() }}",
                    file_path: filePath,
