            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('admin.document.presentations.index')}}">Presentations</a>
                        </li>
                    ...
                    <div class="card-body p-4">
                        <form id="presentationsForm" action="{{ route('admin.document.presentations.edit', $presentations->id) }}" method="post" class="row g-3" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="file_no" name="file_no" value="{{ $presentations->file_no }}" placeholder="L-1222/1/2024-IA-I-(R)">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" id="date_of_publication" name="date_of_publication" value="{{ $presentations->date_of_publication }}" placeholder="date of issue">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="subject" name="subject" value="{{ $presentations->subject }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                <label for="approvedBy" class="form-label">Presentation Approved by <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="approvedBy" name="approvedBy" value="{{ $presentations->approvedBy }}" placeholder="">
                                @if ($errors->has('approvedBy'))
                                    <span class="invalid-feedback">
                                        <strong>{{ $errors->first('approvedBy') }}</strong>
                                    </span>
                                @endif
                                <div id="approvedBy_error" style="color: red; display: none;"></div>
                            </div>
                            <div class="col-md-6">
                                <label for="issuer_name" class="form-label">Issuer Name <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="issuer_name" name="issuer_name" value="{{ $presentations->issuer_name }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="issuer_designation" name="issuer_designation" value="{{ $presentations->issuer_designation }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" name="file_type">
                                    <option value="0" @if($presentations->file_type == 0) selected @endif>Confidential</option>
                                    <option value="1" @if($presentations->file_type == 1) selected @endif>Non-Confidential</option>
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="key" name="key" value="{{ str_replace(',', ' ', $presentations->keyword) }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="field_wrapper">
                                    @if(count($presentations_upload) == 0)
                                    ...
                                    @else
                                        @foreach($presentations_upload as $key => $omu)
...
$(document).ready(function() { 
    $('#presentationsForm').on('submit', function(e) {
        e.preventDefault();  
        ...
        $.ajax({
            ...
            success: function(response) { 
                    // alert(response);
                    // window.location.href = "{{ route('admin.document.presentations.index') }}";
                    Swal.fire({
                    title: "Success!",
...
$(document).ready(function() {
    ...
    if (filePath) {
        if (confirm('Are you sure you want to delete this file?')) {
            ...
            $.ajax({
                url: "{{ route('admin.document.presentations.delete_file') }}", 
                type: 'DELETE',
                data: {
                    _token: "{{ csrf_token() }}",
                    file_path: filePath,
