            ...
            <div class="col-xl-12 mx-auto">
                <div class="card">
                    <div class="card-body p-4">
                        <form action="" id ="achievenmentForm" method="post" class="row g-3" enctype="multipart/form-data">
...
$(document).ready(function() {
    ...
    var achievenmentStoreUrl = "{{ url('admin/document/achievenment/create') }}";
    ...
    $(document).ready(function() {
        ...
        $('select[name="user"]').on('change', function() {
            ...
            if(userId) {
                ...
                $.ajax({
                    url: "{{ route('admin.document.achievenment.get-divisions-by-user') }}",
                    type: 'GET',
                    data: { user_id: userId },
