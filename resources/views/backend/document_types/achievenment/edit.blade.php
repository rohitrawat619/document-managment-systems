                    ...
                    <div class="card-body p-4">
                        <form id="achievenmentForm" action="{{ route('admin.document.achievenment.edit', $achievenment->id) }}" method="post" class="row g-3" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="file_no" name="file_no" value="{{ $achievenment->file_no }}" placeholder="L-1222/1/2024-IA-I-(R)">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" id="date_of_issue" name="date_of_issue" value="{{ $achievenment->date_of_issue }}" placeholder="date of issue">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="subject" name="subject" value="{{ $achievenment->subject }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="issuer_name" name="issuer_name" value="{{ $achievenment->issuer_name }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="issuer_designation" name="issuer_designation" value="{{ $achievenment->issuer_designation }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" name="file_type">
                                    <option value="0" @if($achievenment->file_type == 0) selected @endif>Confidential</option>
                                    <option value="1" @if($achievenment->file_type == 1) selected @endif>Non-Confidential</option>
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="key" name="key" value="{{ str_replace(',', ' ', $achievenment->keyword) }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="field_wrapper">
                                    @if(count($achievenment_upload) == 0)
                                    ...
                                    @else
                                        @foreach($achievenment_upload as $key => $omu)
...
$(document).ready(function() { 
    $('#achievenmentForm').on('submit', function(e) {
        e.preventDefault();  
        ...
        $.ajax({
            ...
            success: function(response) { 
                    // alert(response);
                    // window.location.href = "{{ route('admin.document.achievenment.index') }}";
                    Swal.fire({
                    title: "Success!",
...
$(document).ready(function() {
    ...
    if (filePath) {
        if (confirm('Are you sure you want to delete this file?')) {
            ...
            $.ajax({
                url: "{{ route('admin.document.achievenment.delete_file') }}", 
                type: 'DELETE',
                data: {
                    _token: "{{ csrf_token() }}",
                    file_path: filePath,
