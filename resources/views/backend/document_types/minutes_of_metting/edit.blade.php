                    ...
                    <div class="card-body p-4">
                        <form id ="memorandumForm" action="{{ route('admin.document.minutes_of_metting.edit', $minutes_of_metting->id) }}" method="post" class="row g-3" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" id="date_of_Meeting" name="date_of_Meeting" value="{{ $minutes_of_metting->date_of_Meeting }}" placeholder="date of issue">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="subject" name="subject" value="{{ $minutes_of_metting->subject }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="agenda" name="agenda" value="{{ $minutes_of_metting->agenda }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="issuer_designation" name="issuer_designation" value="{{ $minutes_of_metting->issuer_designation }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="key" name="key" value="{{ str_replace(',', ' ',$minutes_of_metting->keyword) }}" placeholder="">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="field_wrapper">
                                    @if(count($minutes_of_metting_upload) == 0)
                                    ...
                                    @else
                                        @foreach($minutes_of_metting_upload as $key => $omu)
...
$(document).ready(function() {
    ...
    if (filePath) {
        if (confirm('Are you sure you want to delete this file?')) {
            ...
            $.ajax({
                url: "{{ route('admin.document.minutes_of_metting.delete_file') }}", 
                type: 'DELETE',
                data: {
                    _token: "{{ csrf_token() }}",
                    file_path: filePath,
